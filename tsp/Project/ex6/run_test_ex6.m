...
for jump2 = [40 30 20 10]
    %NIND = jump2;
    PR_CROSS = jump2/100; 
    PR_MUT = 1-PR_CROSS;
    jj = 1;
    for jump1= [50 40 30 20 10]
        ...
        for run = 1 : amountOfRuns    
            ...
            t = cputime;
            [fit3,min3,best3] = run_once_ex6(x, y, NIND, MAXGEN, NVAR, ELITIST, STOP_PERCENTAGE, STOP_GEN_AVERAGE, STOP_PERCENTAGE_AVERAGE, STOP_GEN_BEST, STOP_PERCENTAGE_BEST, STOP_PERCENTAGE_RATIO, PR_CROSS, PR_MUT, CROSSOVER, LOCALLOOP, 'tournament');

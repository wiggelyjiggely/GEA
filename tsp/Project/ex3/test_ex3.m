...
ELITIST=0.3;    % percentage of the elite population
...
%for jump2 = [50 100 150]
    ...
    %for jump1= [20 50 100 150 200]
    for jump1= [100 200 400 600 1000]
    %for jump1=[1]
        ...
        for run = 1 : amountOfRuns    
            ...
            t = cputime;
            [fit,min,best] = run_ga_custom_wlm(x, y, NIND, MAXGEN, NVAR, ELITIST, STOP_PERCENTAGE, PR_CROSS, PR_MUT, CROSSOVER, LOCALLOOP,'tournament');

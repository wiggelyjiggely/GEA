function run_ga_with_stop(x, y, NIND, MAXGEN, NVAR, ELITIST,STOP_PERCENTAGE_INDIVIDUALS, STOP_GEN_AVERAGE, STOP_PERCENTAGE_AVERAGE, STOP_GEN_BEST, STOP_PERCENTAGE_BEST, STOP_PERCENTAGE_RATIO, PR_CROSS, PR_MUT, CROSSOVER, LOCALLOOP, ah1, ah2, ah3)
% usage: run_ga(x, y, 
%               NIND, MAXGEN, NVAR, 
...
{NIND MAXGEN NVAR ELITIST STOP_PERCENTAGE STOP_GEN_AVERAGE STOP_PERCENTAGE_AVERAGE STOP_GEN_BEST STOP_PERCENTAGE_BEST STOP_GEN_RATIO STOP_PERCENTAGE_RATIO PR_CROSS PR_MUT CROSSOVER LOCALLOOP}
